...
export default function SprintsPage({ open, onClose }: { open: boolean, onClose: () => void }) {
  if (!open) return null;
  return (
    <div className="w-full">
      ...
      <div className="p-8 bg-white">
        ...
        <p className="text-neutral-700 mb-2">Manage your company sprints here. Add, edit, and organize sprints.</p>
        {/* Placeholder for sprints list/table */}
        <div className="mt-4 p-4 bg-neutral-50 rounded border border-neutral-200 text-neutral-500">No sprints yet.</div>
      </div>
    </div>
  );
} 